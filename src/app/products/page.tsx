...
export default function ProductsPage() {
  return (
    <div className="max-w-7xl mx-auto px-6 py-16">
      ...
      <h2>Smart Search.. رفيقك للوصول إلى المعلومة في ثوانٍ!</h2>

<p>في عالم يمتلئ بالبيانات، لم يعد التحدي في إيجاد المعلومة، بل في الوصول إليها بسرعة ودقة. من هنا انطلقت مجموعة "منتجات Smart Search" لدينا، لتكون الأداة التي تختصر عليك ساعات من البحث التقليدي المجهد.
